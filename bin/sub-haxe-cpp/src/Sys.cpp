...
HX_LOCAL_STACK_FRAME(_hx_pos_7c26c66715ab96ef_32_println,"Sys","println",0x3905f76e,"Sys.println","/opt/hostedtoolcache/haxe/4.3.4/x64/std/cpp/_std/Sys.hx",32,0x810426a9)
HX_LOCAL_STACK_FRAME(_hx_pos_7c26c66715ab96ef_56_args,"Sys","args",0xeaeddc7e,"Sys.args","/opt/hostedtoolcache/haxe/4.3.4/x64/std/cpp/_std/Sys.hx",56,0x810426a9)
HX_LOCAL_STACK_FRAME(_hx_pos_7c26c66715ab96ef_87_systemName,"Sys","systemName",0xbea5b6bb,"Sys.systemName","/opt/hostedtoolcache/haxe/4.3.4/x64/std/cpp/_std/Sys.hx",87,0x810426a9)
...
void Sys_obj::println( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_7c26c66715ab96ef_32_println)
...
::Array< ::String > Sys_obj::args(){
            	HX_STACKFRAME(&_hx_pos_7c26c66715ab96ef_56_args)
...
::String Sys_obj::systemName(){
            	HX_STACKFRAME(&_hx_pos_7c26c66715ab96ef_87_systemName)
